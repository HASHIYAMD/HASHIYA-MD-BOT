...
console.log("Connecting HASHIYA-MD bot 💕🙈...");
...
console.log('HASHIYA-MD connected to whatsapp ✅')

let up = `*👋 HASHIYA-MD ⇨⇨ Connected Successfully!!!!!!* ✅ 

 *WELCOME 😁👋 🛡️HASHIYA-MD!* 🛡️

*🔹 PREFIX:* .

*🔹 OWNER:* 94713457207

*🖇️Join My WhatsApp Channel✓💗 - :* https://whatsapp.com/channel/FUCK
...
if (config.AUTO_BIO === 'true'){
               await
conn.updateProfileStatus(`💖 HASHAN 𝐌𝐃 💖 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱 𝗦𝘂𝗰𝗰𝗲𝘀𝗳𝘂𝗹𝗹𝘆!🛡️`)
 }
...
app.get("/", (req, res) => {
res.send("hey,HASHIYA-MD bot started✅💖");
});
